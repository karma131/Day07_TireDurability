...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split after sentence-ending punctuation while keeping the punctuation
        # attached to the sentence. Newlines are also accepted as whitespace
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # Character-level splitting is the final fallback. It also handles a
        # caller-provided empty separator list gracefully.
        ...
        # Reattach separators so sentence/paragraph punctuation and boundaries
        # are not silently discarded from the chunks.
        parts = [
